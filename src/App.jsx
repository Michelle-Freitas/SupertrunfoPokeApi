  ...
  return (
    ...
    {removeLoading ? (
      <div className='container'>
        <h1>React Supertrunfo <img src={pokebola} alt="pokebola" /><span className='title'>PokeApi</span></h1>
        <CardContainer status={status} pokemonPlayer={pokemonPlayer} pokemonMachine={pokemonMachine}/>
        <div className='buttons'>
          <Button title='Sortear cartas' hadleBtn={hadleSortition} disabled={btnDisabled} />
          <Button title='Recomeçar' hadleBtn={startOver} disabled={!btnDisabled}/>
        </div>
      </div>
    ) : (
      <Loading />
